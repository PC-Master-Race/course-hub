...
<p>RTCF Framework - Quick Reference</p>
...
<p>Quick check: Look at your filled-in RTCF row from Module 2. Does it hit all four components? If not, revise it now. You will use this skill again in Module 5 - today we layer advanced techniques on top of this foundation.</p>
...
<p>Your only task right now: get your notes from Day 1 in front of you and think of one workplace task you have not yet tried in AI. You will use it in today's activity.</p>

<p>Advanced Prompting Techniques</p>

<p>From Framework to Fluency - Techniques That Unlock Professional-Grade Output</p>

<p>From RTCF to Fluency</p>

<p>In Module 2 you learned a structured framework for writing prompts. RTCF gives you a reliable starting point - and for many everyday tasks, it is all you need. But the most effective AI users do not stop at the framework. They layer additional techniques on top of it to get outputs that are more accurate, more tailored, and more immediately useful.</p>
...
<p>Technique 1: Few-Shot Prompting</p>
...
<p>Definition: Few-Shot Prompting</p>
...
<p>Technique 2: Chain-of-Thought Prompting</p>
...
<p>Definition: Chain-of-Thought Prompting</p>
...
<p>Chain-of-Thought in Practice: Two Versions of the Same Prompt</p>
...
<p>Technique 3: Persona + Constraint Prompting</p>
...
<p>The Persona + Constraint Structure</p>
...
<p>Persona + Constraint Across Different Workplaces</p>
...
| Early Childhood Education | You are a preschool teacher writing a weekly parent newsletter. | Always use a warm, encouraging tone. Never use acronyms or educational jargon. Always include one specific classroom highlight from the week. |
...
<p>Technique 4: Iterative Refinement</p>
...
<p>The Iterative Refinement Cycle in Practice</p>
...
<p>When NOT to Use AI: The Professional Judgment Line</p>
...
<p>ACTIVITY: The Prompt Tournament</p>
...
<p>Round 1: Basic Prompt (No Framework)</p>
...
<p>Round 3: Add Few-Shot + Chain-of-Thought</p>
...
<p>After All Three Rounds: Side-by-Side Evaluation</p>
...
<p>Debrief Questions - Class Discussion</p>
...
<p>After completing this module and the Prompt Tournament activity, you should be able to:</p>
...
<p>Image AI: A Practical Intro</p>

<p>Expanding the Toolkit Beyond Text - What Image AI Can Do at Work</p>

<p>Beyond Text: A New Modality in Your Toolkit</p>
...
<p>How Diffusion Models Work - Plain English</p>
...
| Early Childhood & Education | Custom classroom illustrations, story visuals for student materials, parent newsletter headers, culturally inclusive imagery | Teachers can create visuals that reflect their specific student community instead of defaulting to generic stock images. |
...
<p>The Five-Part Image Prompt Formula</p>

<p>[Subject + Setting + Style + Mood/Tone + Format/Specs]</p>
...
<p>Beginner Path: Use This Template Prompt</p>
...
<p>Advanced Path: Write From Scratch and Try Two Style Variations</p>
...
<p>Critique Your Output - Record Your Assessment</p>
...
<p>After completing this module and the Generate for Your Field activity, you should be able to:</p>
...
<p>Coming up after the break: the Anchor Activity - the centerpiece of Week 1. You will put everything from both days together in a structured, field-specific AI audit of your own work. Bring your Day 1 notes.</p>

<p>BONUS SKILL PREVIEW</p>

<p>Audio AI & Chain-of-Thought Reasoning  |  Week 1, Day 2  |</p>

<p>What This Bonus Preview Covers</p>

<p>The final  of Week 1 is a forward-looking glimpse at two powerful AI capabilities you have not yet explored: Audio AI tools and Chain-of-Thought (CoT) reasoning. This preview is intentionally brief - you will go deeper in Weeks 2 and 3. in this session, the goal is simple: expand your sense of what is possible.</p>
...
<p>What Audio AI Can Do For You</p>
...
<p>Live Demonstration: Otter.ai Transcription</p>

<p>Quick Note: AI Voice Synthesis</p>
...
<p>Chain-of-Thought in Plain Language</p>

<p>Standard AI response: You ask a question → AI gives you an answer. No explanation of how it got there.</p>

<p>Chain-of-Thought response: You ask a question → AI works through the problem step by step, showing intermediate reasoning → then gives a final answer.</p>

<p>How to Trigger Chain-of-Thought Reasoning</p>

<p>Prompting Strategies That Activate CoT</p>
...
<p>Live CoT Demo: Student Observation Sheet</p>

<p>Observation Sheet - CoT Live Demo</p>
...
<p>Want to Go Deeper? Further Reading & Resources</p>

<p>Credible Sources for Continued Learning</p>
...
<p>Observation sheet: Students do NOT submit this. It is a structured attention-focusing tool. After the CoT demo, briefly ask 2-3 students to share what they wrote for question 4 - this is your bridge into Week 2.</p>

<ul>
  <li>End of Bonus Skill Preview: Audio AI & Chain-of-Thought Reasoning -</li>
</ul>

<p>WEEK 1 CLOSE & WEEK 2 PREVIEW</p>
...
<p>Word Wall Final Reflection - Class Discussion</p>

<p>Prompt 1: "Look at the words you added at the beginning of Week 1. Which one would you add a footnote to now - something you would want to add or change?"</p>

<p>Prompt 2: "Is there a word on this wall that belongs on the wall from Week 1 that nobody put up? What did we miss?"</p>
...
<p>Exit Ticket: My Week 1 AI Commitment</p>
...
<p>How to Complete Your Exit Ticket</p>
...
<p>Your Week 1-to-Week 2 Challenge</p>

<p>The Challenge:</p>

<p>Take the task you wrote on your exit ticket and actually test it with an AI tool before Week 2. Use what you wrote on your Opportunity Map as your starting prompt. Document what happens - what the AI produced, whether you trusted it, and what you would change.</p>

<p>What to bring to Week 2:</p>
...
<ul>
  ...
  <li>One question the experiment raised that you want to dig into in Week 2</li>
</ul>

<p>You Are the Expert on Your Field - Not the AI</p>
...
<p>Day 2 Quick Reference  |</p>

<p>📖  DAY 2 KEY TERMS & DEFINITIONS</p>
...
<p>✍️  ADVANCED PROMPTING TECHNIQUES  (Building on RTCF)</p>
...
<p>COMBINING TECHNIQUES - Full Example (Healthcare Context)</p>
...
<p>Day 2 Quick Reference  -  Page 2 of 2</p>

<p>🖼️  IMAGE AI - TOOLS, PROMPTS & PROFESSIONAL USE</p>
...
<p>IMAGE PROMPT ANATOMY - The 6 Elements</p>
...
<p>Compare:  'an electrician at work'  →  generic stock photo result  vs.  the prompt above  →  specific, usable professional image</p>

<p>🎙️  AUDIO AI TOOLS - QUICK REFERENCE</p>
