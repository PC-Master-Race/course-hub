...
<p class="standout-question">-- Was there a case study from Module 2 that you kept thinking about? Which one and why?</p>
...
<p>We talked about deskilling in Module 3 in the context of workplace judgment. Here is the broader version of that same concern:</p>
...
<p>Is there any realistic way that bias in the training data, a hallucination (a confident made-up answer), a misclassification, or a bad output could harm someone? Even a small chance counts -- write it down. If you cannot think of any risk, think harder. Every tool has one.</p>
